# LAB-0 canonical downstream dataset
...
- Output: /workspace/tmp/qtrad-r2-lab/LAB-0
- Manifest: /workspace/tmp/qtrad-r2-lab/LAB-0/lab-manifest.json
- Manifest SHA-256: 462e40fa84038156b16c68bde4b68d574ab7862c680657ebd1a0035b39bf0072
...
| POOLED_LOCAL_RIDGE | 0.0000028416634094414193 |
| LOCAL_RIDGE | 0.0000028481068098183947 |
...
- One end-to-end smoke passed on the identical reviewed builder.
...
Earlier LAB-0 and LAB-0-v2 outputs were removed after the canonical rebuild passed full authentication. Failures exposed and led to fixes for incomplete feature semantics, circular baseline extraction, provider-gap timing, exact fold membership, terminal-boundary exclusion, fail-closed downstream loading, and non-development evaluation provenance.

Downstream consumers must use only the exact canonical manifest and SHA above. Do not inspect the terminal former-holdout block for variant selection.
