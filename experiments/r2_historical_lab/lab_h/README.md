...
See [RESULTS.md](RESULTS.md). Model selection used only the three chronological development blocks;
the two frozen finalists were evaluated once on the former consumed holdout as an explicitly
post-hoc development block.
