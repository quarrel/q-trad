...
**Status:** ACTIVE
**Current milestone:** R2 — local and pooled baselines (R2.C complete; R2.D next)
...
- R2.A through R2.C are software-complete implementation evidence. R2.D through R2.F1 may continue
...
| R2 — local and pooled baselines | IN PROGRESS | R2.A–R2.C software is complete; R2.D–R2.F1 software and source-specific integration continue before a qualifying frozen foundation drives confirmatory OOF and locked-holdout evidence |
...
- R2.A through R2.C are software-complete; continue R2.D local Ridge, R2.E pooled controls, R2.F1
  evaluation and the corresponding R2.H software verification. R2.C supplies authenticated,
  training-only preprocessing and primary-horizon local-Ridge alpha-selection evidence; final model
  parameters and forecasts remain R2.D work.
