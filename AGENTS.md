...
The current milestone is **R2 — local and pooled baselines (R2.F1 software complete; R2.H software verification next)**:
...
R0 and the R1 causal multi-asset research foundation are complete. R2.A–R2.F1 software is complete,
and the corresponding R2.H software-verification bundle is next. Confirmatory R2 execution remains gated on a real 23-market
