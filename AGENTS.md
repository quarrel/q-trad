...
The current milestone is **R2 — local and pooled baselines (R2.C complete; R2.D next)**:
...
R0 and the R1 causal multi-asset research foundation are complete. R2.A–R2.C software is complete,
and R2.D local Ridge fitting is next. Confirmatory R2 execution remains gated on a real 23-market
