...
The current milestone is **R2 — local and pooled baselines (R2.D complete; R2.E next)**:
...
R0 and the R1 causal multi-asset research foundation are complete. R2.A–R2.D software is complete,
and R2.E pooled Ridge controls are next. Confirmatory R2 execution remains gated on a real 23-market
