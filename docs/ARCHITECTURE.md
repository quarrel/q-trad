...
The current 20-market `capture-v3` release remains active until a separately reviewed and authorised
replacement. China A50 and Korea 200 review uses the established catalogue → non-authoritative
provider review → operator selection → immutable release → separate activation boundary.
